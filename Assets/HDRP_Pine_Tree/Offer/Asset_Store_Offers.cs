...
public class Asset_Store_Offers : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        Texture2D ad1 = EditorGUIUtility.Load("Assets/HDRP_Pine_Tree/Offer/Ads/ad1.psd") as Texture2D;
        Texture2D ad2 = EditorGUIUtility.Load("Assets/HDRP_Pine_Tree/Offer/Ads/ad2.psd") as Texture2D;
        Texture2D ad3 = EditorGUIUtility.Load("Assets/HDRP_Pine_Tree/Offer/Ads/ad3.psd") as Texture2D;
...
public class Startup
{
    static Startup()
    {
        ...
        if (EditorPrefs.GetInt("showCounts_HDRP_Pine_Tree") == 10)
        { 
